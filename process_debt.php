...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql4 = "INSERT INTO `debts` (`debt_id`, `student_id`, `discipline_id`) VALUES (NULL, ?, ?)";
    $stmt4 = $conn->prepare($sql4);
    $stmt4->bind_param("ii", $student_id, $discipline_id);
    $stmt4->execute();

    if ($stmt4->affected_rows === 1) {
        echo "Долг проставлен";
    } else {
        echo "Ошибка при проставлении долга";
    }
